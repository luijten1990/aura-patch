...
const campaignTiles = [
  ["/images/ambassador-daily-ritual.png", "Wellness", "in real life"],
  ["/images/ambassador-apply.png", "Share your ritual", "in your own voice"],
  ["/images/ambassador-create.png", "Create with intention", "earn as you inspire"],
