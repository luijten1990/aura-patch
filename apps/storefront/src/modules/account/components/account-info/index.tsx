...
const AccountInfo = ({
  ...
  return (
    <div className="text-[15px] text-aura-forest" data-testid={dataTestid}>
      <div className="flex items-end justify-between">
        <div className="flex flex-col">
          <span className="aura-eyebrow text-aura-gold">{label}</span>
          <div className="mt-2 flex flex-1 basis-0 items-center justify-end gap-x-4">
        ...
        <div>
          <Button
            variant="secondary"
            className="h-9 min-h-[25px] w-[100px] rounded-full border-aura-forest/20 bg-[#f5efe4] py-1 text-[11px] font-bold uppercase tracking-[0.14em] text-aura-forest hover:!bg-aura-forest hover:!text-aura-cream"
