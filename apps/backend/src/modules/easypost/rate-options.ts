...
export const EASYPOST_RATE_OPTIONS: EasyPostRateOption[] = [
  {
    ...
    description: "USPS · tracked · typically 2–5 business days",
    code: "usps-ground",
    zone: "us",
  },
  {
    ...
    description: "USPS · tracked · typically 1–3 business days",
    code: "usps-priority",
    zone: "us",
  },
  {
    ...
    name: "UPS Ground",
    description: "UPS · tracked · typically 1–5 business days",
    code: "ups-ground",
    zone: "us",
  },
  {
    id: "easypost-express",
    name: "Express",
    description: "USPS Priority Express, UPS Next Day, or similar · typically 1–2 business days",
    code: "express",
    zone: "us",
  },
  {
    ...
    description: "DHL eCommerce, USPS, or similar · tracked · typically 6–12 business days",
    code: "intl-standard",
    zone: "intl",
  },
  {
    ...
    description: "DHL Express or UPS Worldwide · tracked · typically 1–4 business days",
    code: "intl-express",
    zone: "intl",
  },
]
